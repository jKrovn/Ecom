            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        ...
                        myHeaders.append("Content-Type", "application/json")
                        myHeaders.append("Authorization", "Bearer " + this.props.jwt)
                        fetch("http://localhost:4000/admin/deletemovie/" + this.state.movie.id, { method: "GET", headers: myHeaders })
                            .then(response => response.json())
                            .then(data => {
                                if (data.error) {
                                    this.setState({
                ...
                <Fragment>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <Input
                            ...
                            handleChange={this.handleChange}
                        />
                        <TextArea title={"Description"} name={"description"} value={movie.description} rows={"3"} handleChange={this.handleChange} />
                        <hr />
